...
public interface ISunHotelsService
{
    ...
    /// <summary>
    /// Otel detaylarını getirir. destinationId veya resortId parametrelerinden en az biri önerilir.
    /// </summary>
    Task<SunHotelsSearchResultV3?> GetHotelDetailsAsync(int hotelId, DateTime checkIn, DateTime checkOut, int adults, int children = 0, string currency = "EUR", string? destinationId = null, string? resortId = null, CancellationToken cancellationToken = default);
