...
namespace FreeStays.Infrastructure.Migrations
{
    ...
    [Migration("20260116222239_20260117_AddVerificationTokenAndEmailSettings")]
    partial class _20260117_AddVerificationTokenAndEmailSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.FeaturedDestination", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FeaturedDestinations", (string)null);
                });

            modelBuilder.Entity("FreeStays.Domain.Entities.FeaturedHotel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FeaturedHotels", (string)null);
                });
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.JobHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.MediaFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.PaymentSetting", b =>
                {
                    ...
                    b.Property<string>("LiveModePublicKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("LiveModeSecretKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("TestModePublicKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<string>("TestModeSecretKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.SeoSetting", b =>
                {
                    ...
                    b.Property<bool>("EnableFaqSchema")
                        .HasColumnType("boolean");

                    b.Property<bool>("EnableSearchActionSchema")
                        .HasColumnType("boolean");

                    b.Property<string>("HotelAddress")
                        .HasColumnType("jsonb");

                    b.Property<string>("HotelAggregateRating")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("HotelPriceRange")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("HotelSchemaType")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("HotelTelephone")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("OrganizationSocialProfiles")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("SearchActionTarget")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
                    ...
                    b.Property<string>("WebsiteSearchActionTarget")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.FaqTranslation", b =>
                {
                    b.HasOne("FreeStays.Domain.Entities.Faq", "Faq")
            ...
            modelBuilder.Entity("FreeStays.Domain.Entities.MediaFile", b =>
                {
                    b.HasOne("FreeStays.Domain.Entities.User", "Uploader")
                        .WithMany()
